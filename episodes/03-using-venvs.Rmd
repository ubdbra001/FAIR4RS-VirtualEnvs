...
Not quite, the next step is activating the environment. Effectively telling your operating system 
...
```
Which will set the virtual environment directory name to `venv`, and the console prompt to 
`my-new-project`:
...
But you now have two Python executables on your computer (at least), how does you computer know 
...
a seperate Python interpreter and library)
